...
publicWidget.registry.AdiHelpdeskEmailCheck = publicWidget.Widget.extend({
    ...
    start() {
        ...
        this.nameGroup = this.nameInput.closest(".s_website_form_field") || this.nameInput.closest(".form-group") || this.nameInput.parentElement;
        this.companyGroup = this.companyInput.closest(".s_website_form_field") || this.companyInput.closest(".form-group") || this.companyInput.parentElement;

        this.message = document.createElement("div");
        this.message.className = "text-muted mt-2";
